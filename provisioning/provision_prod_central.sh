...
apt-get -y update
apt-get -y install nginx mysql-server mysql-client php5-fpm php5-cli php5-gd php5-mcrypt php5-mysql php-apc
...
sudo -s cp /vagrant/provisioning/conf/nginx_prod_central.conf /etc/nginx/sites-available/default
